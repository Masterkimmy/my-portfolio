...
const Design = () => {
  return (
    <div>
      <div className="h-[100vh] flex gap-44 justify-center max-sm:flex-col max-sm:items-center max-sm:gap-20 max-sm:h-[80vh] ">
        <div className=" relative top-24 max-sm:top-0">
          <h1 className="text-[#4831D4] font-extrabold text-[50px] chrismi max-sm:text-[35px]"> Design </h1>
          <p className="text-[#3D155F] w-[37vw] max-sm:w-[80vw] chrismi">
        ...
        <div className="relative top-80 max-sm:top-0 ">
          ...
          <h1 className="text-[#4831D4] font-extrabold text-[50px] chrismi max-sm:text-[35px]">
            Engineering
          </h1>
          <p className=" text-[#3D155F] w-[35vw] max-sm:w-[80vw] chrismi">
